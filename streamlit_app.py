...
find_text = st.text_input("Enter Initial File Name")
replace_text = st.text_input("Enter Final File Name")
...
if st.button("Rename Files"):
    if uploaded_zip and find_text:
        ...
        with open(output_zip_path, "rb") as f:
            st.download_button("Download Renamed Files", f, file_name="renamed_dxf_files.zip")
    else:
